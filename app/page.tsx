  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen overflow-hidden">
      ...
      <div className="grid grid-cols-2 px-8 md:grid-cols-1 pt-20">
        <div className="z-10 flex items-center justify-center md:flex-col">
          <div className="pl-20 md:pl-0 md:w-full">
            <div className="flex flex-col justify-center overflow-hidden">
              ...
              <div className="flex-row flex">
                ...
                <span className="text-3xl md:text-8xl px-2 z-10 text-transparent duration-1000 bg-lime-400 cursor-default text-edge-outline animate-title font-display whitespace-nowrap bg-clip-text">
              ...
              <div className="inline-block px-10 text-left animate-fade-in z-15 w-1/2 mt-8">
                <h2 className="text-md text-zinc-500 md:text-3xl">
                  I&apos;m a full time student from Upstate New York studying robotics and computer science at WPI.
                </h2>
              </div>
            </div>
          </div>
